            ...
            <Dialog.Panel className="fixed bottom-0 right-0 top-0 flex h-full w-full flex-col border-l border-neutral-200 bg-white p-6 text-black md:w-[390px]">
              ...
              {!cart || cart.lines.length === 0 ? (
                <div className="mt-20 flex w-full flex-col items-center justify-center overflow-hidden">
                  ...
                  <Link
                    href="/search/all"
                    className="button-style my-5 bg-customViolet px-4 py-2 text-white hover:bg-customViolet/70"
                  >
                    Explore Products
                ...
                <div className="flex h-full flex-col justify-between overflow-hidden p-1">
                  ...
                  <a
                    ...
                    className="block w-full rounded-full bg-customViolet p-3 text-center text-sm font-medium text-white opacity-90 hover:opacity-100"
                  >
                    Proceed to Checkout
                  </a>
                </div>
